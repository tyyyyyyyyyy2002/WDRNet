...
# 日志文件路径
log_file = "/data/workspace/tyy/demo/contrastive-unpaired-translation-master/checkpoints/grumpycat_FastCUT2wavepatchplus2/loss_log.txt"
save_path = "G_loss_curve2.png"  # 保存图片路径
